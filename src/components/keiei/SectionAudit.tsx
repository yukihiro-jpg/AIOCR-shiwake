    ...
    <div className="space-y-5">
      ...
      <Section title="解析の実行" note="対象月の取引を、それ以前の全実績（過去期＋進行期の過去月）と突合します">
        ...
        <div className="text-[11px] text-gray-400 mt-3 leading-relaxed">
          判定内容: ①同一科目×同一摘要の<b>税区分の逸脱</b>（過去は課税10%なのに今回は非課税等）
          ②過去に預り金仕訳を伴った支払いの<b>源泉徴収の処理漏れ</b>
          ③<b>補助金・助成金・保険金・還付金等の入金が課税処理</b>されているもの（原則不課税）
          ④同一摘要の<b>計上科目の相違</b>。すべてブラウザ内の機械判定で、外部・AIには送信されません。
        </div>
      </Section>
    </div>
  )
